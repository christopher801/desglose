// ventanas/p-65/p-65.js
import FractionUtils from '../../utils/fraction.js';

// P-65 calculation formulas
const P65 = {
    calcular(ancho, alto, hojas) {
        ...
        if (hojas === 2) {
            parts.push(
                { tipo: 'HOJA', pieza: 'CAB-ALF', medida: (ancho / 2) - (11/16) },
                ...
                { tipo: 'VIDRIO', pieza: 'ANCHO', medida: (ancho / 2) - (3 + 3/16) },
            ...
            parts.push(
                ...
                { tipo: 'MARCO', pieza: 'CAB-RIEL', medida: ancho - (1 + 3/8) },
                { tipo: 'MARCO', pieza: 'LATERAL', medida: alto - (1/8) },
                { tipo: 'VIDRIO', pieza: 'ANCHO', medida: (ancho / 4) - (2 + 7/8) },
                { tipo: 'VIDRIO', pieza: 'ALTO', medida: alto - (4 + 15/16) }
            );
        }
...
function handleAgregar() {
    ...
    const parts = P65.calcular(anchoDec, altoDec, hojas);
