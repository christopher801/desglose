// ventanas/p-92/p-92.js
import FractionUtils from '../../utils/fraction.js';

// P-92 calculation formulas
const P92 = {
    calcular(ancho, alto, hojas) {
        ...
        if (hojas === 2) {
            parts.push(
                { tipo: 'HOJA', pieza: 'CAB-ALF', medida: (ancho / 2) - (9/16) },
                { tipo: 'HOJA', pieza: 'JAMBAS', medida: alto - (2 + 7/16) },
                { tipo: 'MARCO', pieza: 'CAB-RIEL', medida: ancho - (1 + 5/8) },
                { tipo: 'MARCO', pieza: 'LATERAL', medida: alto - (1/8) },
                { tipo: 'VIDRIO', pieza: 'ANCHO', medida: (ancho / 2) - (3 + 13/16) },
                { tipo: 'VIDRIO', pieza: 'ALTO', medida: alto - (6 + 9/16) }
            );
        } else if (hojas === 3) {
            parts.push(
                { tipo: 'HOJA', pieza: 'CAB-ALF', medida: (ancho / 3) + (1/8) },
                { tipo: 'HOJA', pieza: 'JAMBAS', medida: alto - (2 + 7/16) },
                { tipo: 'MARCO', pieza: 'CAB-RIEL', medida: ancho - (1 + 5/8) },
                { tipo: 'MARCO', pieza: 'LATERAL', medida: alto - (1/8) },
                { tipo: 'VIDRIO', pieza: 'ANCHO LATERAL', medida: (ancho / 3) - (3 + 2/16) },
                { tipo: 'VIDRIO', pieza: 'ANCHO MEDIO', medida: (ancho / 3) - (3 + 5/8) },
                { tipo: 'VIDRIO', pieza: 'ALTO', medida: alto - (6 + 7/16) }
            );
        } else if (hojas === 4) {
            parts.push(
                ...
                { tipo: 'MARCO', pieza: 'CAB-RIEL', medida: ancho - (1 + 5/8) },
                { tipo: 'MARCO', pieza: 'LATERAL', medida: alto - (1/8) },
                { tipo: 'VIDRIO', pieza: 'ANCHO', medida: (ancho / 4) - (3 + 3/8) },
                { tipo: 'VIDRIO', pieza: 'ALTO', medida: alto - (6 + 7/16) }
            );
        }
...
function handleAgregar() {
    ...
    const parts = P92.calcular(anchoDec, altoDec, hojas);
